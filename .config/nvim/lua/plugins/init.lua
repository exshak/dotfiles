return {
  ...
  -- lspconfig
  {
    ...
    opts = {
      ...
      servers = { lua_ls = { settings = { Lua = { workspace = { library = { vim.env.VIMRUNTIME } } } } } },
    },
  },
    ...
    opts = function()
      ...
      return {
        ...
        options = {
          ...
          disabled_filetypes = {
            statusline = { "checkhealth", "lazy", "lazyterm", "mason", "snacks_dashboard", "snacks_picker_input" },
          },
          globalstatus = true,
          section_separators = "",
          theme = "auto",
  ...
  -- snacks
  {
    ...
    opts = {
      ...
      picker = {
        -- stylua: ignore
        actions = {
          toggle_db = function(p) local opts = p.opts opts.dirs = not opts.dirs and { "~/Dropbox" } or nil p:find() end,
          toggle_lua = function(p) local opts = p.opts opts.ft = not opts.ft and "lua" or nil p:find() end,
        },
        sources = {
          explorer = {
            hidden = true,
