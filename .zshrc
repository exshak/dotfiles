...
zinit ice wait"0c" lucid reset \
  atclone"local P=${${(M)OSTYPE:#*darwin*}:+g}
    \${P}sed -i '/DIR/c\DIR 38;5;5;1' LS_COLORS; \
...
export HISTORY_IGNORE="[bf]g|clear|exit|history|l[adfls]" # Do not record some commands.
...
export GPG_TTY=$(tty)
export LESSHISTFILE=-
export TERMINFO_DIRS=~/.config/terminfo
...
alias la="ls -lA"
alias ld="ls -ld"
alias le="exa -la --icons --group-directories-first"
alias lf="ls -lf"
alias ll="lsd -lA"
alias lo="ls -lo"
alias lr="ls -lr"
alias lt="lr -lt"
alias l1="ls -la --tree=1"
alias l2="ls -la --tree=2"
alias l3="ls -la --tree=3"
alias l4="ls -la --tree=4"
...
command -v bat  > /dev/null && export FZF_CTRL_T_OPTS="--preview 'bat -n --color=always --theme=Dracula {}'"
